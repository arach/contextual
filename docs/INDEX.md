...
Contextual is moving toward agentic context planning: inspect prior work, package reusable context as cartridges, instantiate a new run in a target harness, and fork from known provenance. It does not try to promise exact control over a provider or harness buffer after a session is already in flight.
...
| Presentation | Status | Purpose |
| --- | --- | --- |
| [CTX-001-scope-and-boundary.md](./presentations/CTX-001-scope-and-boundary.md) | active | Product boundary and truth rules |
| [CTX-002-the-cartridge.md](./presentations/CTX-002-the-cartridge.md) | active | Cartridge artifact shape |
| [CTX-003-the-planner.md](./presentations/CTX-003-the-planner.md) | active | Collaborative planner model |
| [CTX-004-evidence-and-health.md](./presentations/CTX-004-evidence-and-health.md) | draft | Health recommendation model |
| [CTX-005-launch-and-fork.md](./presentations/CTX-005-launch-and-fork.md) | active | Launch and fork lineage model |
